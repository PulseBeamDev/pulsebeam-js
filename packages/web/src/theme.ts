...
export const pulseBeamStyles = css`
  ...
  * { box-sizing: border-box; }
  ...
  :host-context(html.dark) {
    ...
    --md-sys-color-primary: var(--pb-blue);
    --md-sys-color-on-primary: #ffffff;
    --md-sys-color-surface: var(--pb-paper);
    --md-sys-color-on-surface: var(--pb-text);
    --md-sys-color-outline: var(--pb-border-dk);

    /* Dark Mode Switch - High Contrast Preserved */
    --md-switch-selected-track-color: var(--pb-blue);
    --md-switch-selected-track-outline-color: var(--pb-blue);
    --md-switch-selected-handle-color: #ffffff; 

    --md-switch-track-color: transparent;
    --md-switch-track-outline-color: var(--pb-text-dim);
    --md-switch-handle-color: var(--pb-text-dim);
...
export const legacyLayoutStyles = css`
  ...
  /* --- SIDEBAR --- */
  aside {
    background: var(--pb-paper); /* Updated for Theme Support (was #fff) */
  ...
  /* Dark mode fix for active state */
  :host-context(html.dark) nav a.active {
  ...
  :host-context(html.dark) main {
     background-image: radial-gradient(rgba(255,255,255,0.05) 1px, transparent 1px);
  }

  header {
    background: var(--pb-paper); /* Updated from rgba(255,255,255,0.9) */
    opacity: 0.95;
  ...
  .tag { 
    ...
    background: var(--pb-paper); padding: 3px 8px; 
  ...
  section > header {
    ...
    border-bottom: 1px solid var(--pb-border);
    background: var(--pb-canvas); /* Theme aware */
    display: flex; align-items: center; justify-content: space-between;
  }
  ...
  th { 
    ...
    background: transparent; border-bottom: 1px solid var(--pb-border); 
